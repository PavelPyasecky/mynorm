...
class ActivityStatisticsService:
    ...
    def start_activity(self, data: dict, previous_activity_statistic: ActivityStatistics = None, new_activity: Activity = None) -> ActivityStatistics:
...
class SupervisionService:
    ...
    def finish_supervision(supervision: Supervision):
        last_activity_statistic = supervision.statistics.filter(supervision=supervision, end_date__isnull=True).last()
